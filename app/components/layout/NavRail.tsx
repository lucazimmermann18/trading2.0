...
const NAV_ITEMS: { id: ViewId; label: string; icon: React.ReactNode }[] = [
  ...
  { id: "intermarket", label: "Intermarket", icon: <svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" strokeWidth="1.5"><path d="M3 17l4-5 4 3 4-6 4 4"/><circle cx="3" cy="17" r="1.5" fill="currentColor"/><circle cx="19" cy="13" r="1.5" fill="currentColor"/></svg> },
